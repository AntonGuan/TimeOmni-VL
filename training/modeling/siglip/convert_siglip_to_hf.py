...
def convert_siglip_checkpoint(model_name, pytorch_dump_folder_path, verify_logits=True, push_to_hub=False):
    ...
    if "i18n" in model_name:
        vocab_file = "/Documents/SigLIP/multilingual_vocab/sentencepiece.model"
    else:
        vocab_file = "/Documents/SigLIP/english_vocab/sentencepiece.model"
    ...
    if push_to_hub:
        model.push_to_hub(f"anonymous-timeomni/{model_name}")
        processor.push_to_hub(f"anonymous-timeomni/{model_name}")
